...
plot(fold_changes_df$logFC, -1*log(as.numeric(fold_changes_df$p_val)), pch='.')
...
```{r}
plot(fold_changes_df_sim_varconf_lm$logFC, -1*log(as.numeric(fold_changes_df_sim_varconf_lm$p_val_for_mean)), pch='.')
